...
module.exports = function(S) {
  ...
  class RuntimeStreamline extends S.classes.Runtime {
    ...
    _streamline(func, pathDist) {
      ...
      SCli.log('_streamline ----------------- func: ' + func);
      console.log(func);
      ...
      //const functionFile    = path.join(config.dir, handlerArr[0]);
      ...
      let b = {
        bundle: function(cb){
          ...
          streamline.compile(function(err, compiled){
            if(err){
              console.error('Error compiling:', err);
            }
            else{
              console.log('Success compiling!', compiled);
            }

            let file = fs.readFileSync(pathBundle).toString();
        ...
        writeToFileAsync: function(pathBundle, buf){
          //writeToFileAsync
          //console.log('BOGUS writeToFileAsync', pathBundle, buf);

          SCli.log('\n\n\n WRITE buf TO pathBundle!!!');
          SCli.log(buf);
          SCli.log(pathBundle);
          SCli.log('\n\n\n');
